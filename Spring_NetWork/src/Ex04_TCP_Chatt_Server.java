...
class ServerSend extends Thread{
	...
	@Override
	public void run() { //다른 stack main 함수와 같은역할
		...
		try {
			...
			*/
			...
			pw = new PrintWriter(socket.getOutputStream(),true); //현재 연결된 통로로부터 write를 할 것이다
...
//카톡을 잘 보면 창이 두 개다 채팅내용을 보여주는 창과 입력하는 창
//두 개는 별개의 스레드인 것이다

//Read : socket > inputStream
class ServerReceive extends Thread{ //읽어들이는 스레드
